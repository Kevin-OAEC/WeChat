package com.oaec.wechat.adapter;
...
public class FragmentTabAdapter implements RadioGroup.OnCheckedChangeListener {
    ...
    public FragmentTabAdapter(FragmentActivity fragmentActivity,
                              List<Fragment> fragments, List<String> tags, int fragmentContentId, RadioGroup rgs) {
        ...
        FragmentTransaction ft = fragmentActivity.getSupportFragmentManager()
                .beginTransaction();
        ft.add(fragmentContentId, fragments.get(0), tags.get(0));
    ...
    public void selectTab(int i) {
        ...
        if (fragment.isAdded()) {
            ...
            Log.d(TAG, "selectTab: "+fragment+"-"+tag);
        }
        showTab(i); // 显示目标tab
        ft.commitAllowingStateLoss();
        ...
        if (null != onRgsExtraCheckedChangedListener) {
            onRgsExtraCheckedChangedListener.OnRgsExtraCheckedChanged(
                    rgs, rgs.getCheckedRadioButtonId(), i);
        }
