package com.oaec.wechat.widget;
            ...
            for (int i = 0; i < n; i++) {
                ...
                switch (attr) {
                    ...
                    case R.styleable.MyRadioButton_drawableTopWidth:
                        mTopWidth = (int) (a.getDimension(attr, 20));
//                        mTopWidth = (int) (a.getDimension(attr, 20));
                        Log.d(TAG, "initView: "+mTopWidth);
                        break;
